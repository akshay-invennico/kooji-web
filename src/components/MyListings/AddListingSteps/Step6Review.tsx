    ...
    <div className="w-full animate-in fade-in slide-in-from-bottom-4 duration-500 pb-20">
      ...
      <div className="space-y-10">
        ...
        <div className="flex flex-col gap-4">
          <div className="w-full h-[400px] rounded-md overflow-hidden bg-gray-100 border border-[#F0EFEF]">
            {coverPhoto ? (
          ...
          <div className="grid grid-cols-4 gap-4">
            {galleryPhotos.map((photo: string | null, index: number) => (
              <div key={index} className="h-32 rounded-md overflow-hidden bg-gray-100 border border-[#F0EFEF] relative">
                {photo ? (
        ...
        <div>
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-2 text-[#000000] text-[14px]">
              <div className="w-5 h-5 flex items-center justify-center text-[#FF3A44]">
            ...
            <button className="text-[#FF3A44] text-[14px] font-bold flex items-center gap-1">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          {/* Pricing Card */}
          <div className="bg-[#F8F8F8] p-6 rounded-md relative">
            <div className="flex justify-between items-start mb-6">
              <div className="flex flex-col">
                <div className="flex items-baseline gap-1.5">
                  <span className="text-[#000000] text-[15px] font-bold">Price:</span>
                  <span className="text-[#FF3A44] text-[24px] font-bold">${pricing.dailyPrice}</span>
            ...
            <div className="flex gap-8 mb-8">
              <div className="flex items-baseline gap-1.5">
                <span className="text-[#FF3A44] text-[17px] font-bold">${pricing.weeklyPrice}</span>
                <span className="text-gray-400 text-[14px] font-bold">/Week</span>
              </div>
              <div className="flex items-baseline gap-1.5">
                <span className="text-[#FF3A44] text-[17px] font-bold">${pricing.monthlyPrice}</span>
            ...
            <div className="grid grid-cols-2 gap-4">
              <div className="flex flex-col gap-1.5">
                <span className="text-[#000000] text-[14px] font-bold">From</span>
                <div className="bg-white px-3 py-2.5 rounded-md flex items-center gap-2 border border-[#F0EFEF]">
                  ...
                  <span className="text-[13px] font-bold text-[#000000] whitespace-nowrap">{formatDate(startDate)}</span>
                </div>
              </div>
              <div className="flex flex-col gap-1.5">
                <span className="text-[#000000] text-[14px] font-bold">To</span>
                <div className="bg-white px-3 py-2.5 rounded-md flex items-center gap-2 border border-[#F0EFEF]">
                  <Icon component={Calendar} size="xs" className="text-gray-400" />
                  <span className="text-[13px] font-bold text-[#000000] whitespace-nowrap">{formatDate(endDate)}</span>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="bg-white border border-[#F0EFEF] p-6 rounded-md">
            <h3 className="text-[17px] font-semibold text-[#000000] mb-2 font-outfit">Delivery & Pickup</h3>
            ...
            <div className="flex flex-col gap-6">
              <div className="flex items-start gap-3">
                <div className="p-2.5 bg-[#FF3A44]/10 rounded-md">
                  <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#FF3A44" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><rect x="1" y="3" width="15" height="13"></rect><polygon points="16 8 20 8 23 11 23 16 16 16 16 8"></polygon><circle cx="5.5" cy="18.5" r="2.5"></circle><circle cx="18.5" cy="18.5" r="2.5"></circle></svg>
                </div>
                <div>
                  ...
                  <div className="text-[13px] font-bold text-gray-401">
                    {selectedType === 'equipment' ? (
                      <>
                        <span className="text-[#FF3A44] font-bold">${pricing.selfDeliveryPrice || '0'}</span>
                        <span className="text-gray-400 ml-1 font-bold">for Drop & Pickup</span>
                      </>
        ...
        <div className="space-y-8 pt-4">
          <div>
            <h3 className="text-[17px] font-semibold text-[#000000] mb-4 font-outfit">Description</h3>
            <div className="space-y-6">
              <div>
                <h4 className="text-[15px] font-bold text-[#000000] mb-2">Overview</h4>
              ...
              {venueHighlights.length > 0 && (
                <div>
                  <h4 className="text-[15px] font-bold text-[#000000] mb-2">Venue Highlights</h4>
          ...
          {/* Specifications */}
          <div className="bg-[#F8F8F8] p-8 rounded-md">
            <h3 className="text-[17px] font-semibold text-[#000000] mb-6 font-outfit">Specifications</h3>
            {selectedType === 'equipment' ? (
              <div className="grid grid-cols-1 md:grid-cols-2 gap-x-12 gap-y-4">
                <div className="space-y-3">
                  <div className="flex gap-2 text-[14px]">
                    <span className="text-gray-400 font-medium">• Brand:</span>
                    <span className="text-[#000000] font-bold">{brand}</span>
                  </div>
                  <div className="flex gap-2 text-[14px]">
