...
const ListingCard: React.FC<ListingCardProps> = ({ rating, totalReviews, title, address, price, image }) => {
    return (
        <div className="w-full bg-white rounded-xl overflow-hidden border border-gray-100 group cursor-pointer h-full flex flex-col">
