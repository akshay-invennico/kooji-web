            ...
            <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
                <div>
                    ...
                    <div className="flex gap-6">
                        <img src="/icons/social/social1.svg" alt="social" className="w-10 h-10" />
                        <img src="/icons/social/social2.svg" alt="social" className="w-10 h-10" />
                        <img src="/icons/social/social3.svg" alt="social" className="w-10 h-10" />
                        <img src="/icons/social/social4.svg" alt="social" className="w-10 h-10" />
                    </div>
                </div>
