...
const CreateWithKooji = () => {
    return (
        <section className="p-3 bg-white relative">
            <div className="max-w-8xl mx-auto">
                <div className="text-center w-[684px] mx-auto  mb-20 relative z-20">
                    <h2 className="text-[36px]  font-bold text-[#000000] mb-4">Created with Kooji</h2>
                ...
                <div className="relative">
                    ...
                    <div className="absolute top-0 left-0 right-0 h-48 bg-gradient-to-b from-white to-transparent z-10 pointer-events-none"></div>
                    ...
                    <div className="grid grid-cols-5 gap-2 sm:gap-3 md:gap-4">
                        ...
                        <div className="flex flex-col gap-2 sm:gap-3 md:gap-4 mb-15">
                            ...
                            <img src="/assets/createWithKooji/create9.png" alt="Created with Kooji 9" className="w-full rounded-lg sm:rounded-lg md:rounded-lg object-cover " />
                        </div>
                    ...
                    <div className="absolute bottom-0 left-0 right-0 h-48 bg-gradient-to-t from-white via-white/70 sm:via-white/80 md:via-white/90 to-transparent z-10 pointer-events-none"></div>
                </div>
            </div>
        </section>
    )
